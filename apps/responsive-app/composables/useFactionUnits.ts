...
import { fetchFactionUnits, type Unit } from '@tww3-brawl/sdk';
 ...
 */
export function useFactionUnits(
  ...
  return useQuery<Unit[]>({
    ...
    queryFn: () => fetchFactionUnits(graphqlClient, versionId.value, factionKey.value),
